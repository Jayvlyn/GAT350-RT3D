...
namespace nc
{
    ...
    void World04::Update(float dt)
    {
        ...
        {
            ImGui::DragFloat("Inner Angle", &m_lights[m_selected].innerAngle, 0.1f, 0, m_lights[m_selected].outerAngle - 0.1f);
            ImGui::DragFloat("Outer Angle", &m_lights[m_selected].outerAngle, 0.1f, m_lights[m_selected].innerAngle + 0.1f, 90);
        }

        ImGui::ColorEdit3("Color", glm::value_ptr(m_lights[m_selected].color));
        ImGui::DragFloat("Intensity", &m_lights[m_selected].intensity, 0.1f, 0.1f, 50.0f);
        ImGui::End();
