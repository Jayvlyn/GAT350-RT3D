...
// Added location for shadow coord
...
// Added uniform for shadowTexture
...
void main()
{
    ...
    // set shadow using calculateShadow
	...
	for (int i = 0; i < numLights; i++)
	{
        ...
        // Added shadow onto the multiplication
